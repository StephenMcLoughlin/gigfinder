...
$query = mysql_query($tbl_useroptions); 
if ($query === TRUE) {
...
$query = mysql_query($tbl_blockedusers); 
if ($query === TRUE) {
...
$query = mysql_query($tbl_notifications); 
if ($query === TRUE) {
